...
public class UserWebService {
    ...
    public String register(@WebParam(name = "nama") String nama,
    ...
    public ArrayList<String> getAllUsers() {
        ...
        for (Object obj : listUsers) {
            Users u = (Users) obj;
            String baris = u.getId() + "|" + u.getNama() + "|" + u.getAlamat() + "|"
                    + u.getEmail() + "|" + u.getUsername() + "|" + u.getHakAkses();
    ...
    public String getUserById(@WebParam(name = "id") int id) {
        Users modelUser = new Users();
        java.util.ArrayList<Object> listUsers = modelUser.viewListData();
        for (Object obj : listUsers) {
            Users u = (Users) obj;
            if (u.getId() == id) {
    ...
    public String updateProfile(@WebParam(name = "id") int id,
                                @WebParam(name = "nama") String nama,
                                @WebParam(name = "alamat") String alamat,
                                @WebParam(name = "email") String email,
                                @WebParam(name = "username") String username,
                                @WebParam(name = "password") String password,
                                @WebParam(name = "hakAkses") String hakAkses) {
        try {
            Users user = new Users();
            user.setId(id);
            user.setNama(nama);
